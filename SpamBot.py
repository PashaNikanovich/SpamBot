...
print('CyberTrack-ng запущен')
print('Для активации Spam бота введите: Я люблю твою мамку')


@client.on_message(filters.regex('Я люблю твою мамку|я люблю твою мамку') & filters.me)
def ghoul_spam_handler(client, message):
    i = 666
    while i > 0:
        try:
            client.send_message(message.chat.id, f'{i} - 1 = {i-7}')
